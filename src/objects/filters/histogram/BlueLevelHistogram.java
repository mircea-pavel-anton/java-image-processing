...
public class BlueLevelHistogram extends AbstractHistogramFilter {
	 ...
	 */
	public BlueLevelHistogram(final int width, final int height, final int samples) {
		super(samples, true, "blue");
	 ...
	 * reported by blueLevelHistogram
	 * 
	...
	public Image filter(final Image image) {
		...
		final int maxValue = Arrays.stream(blueLevelHistogram).max().getAsInt();
