...
public class Prompter {
	...
	private Prompter() { sc = new Scanner(System.in); }
	
	/** Closes the Scanner */
	public void close() { sc.close(); }

	/** Prompts the user to enter an integer, and keeps asking until it is within the given bounds
	 * 
	...
	/** Prompt the user for a double value, and keep asking until it is within the given bounds
	 * 
	 * @param prompt -> text to be displayed
	 * @param leftBound -> start of accepted interval
	 * @param rightBound -> end of accepted interval
